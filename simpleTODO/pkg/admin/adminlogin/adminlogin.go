					...
					if databasetools.ValidateUserInfoFormInputs("username", username) {
						if databasetools.ValidateUserInfoFormInputs("password", password) {
							...
							if ValidateUser(username, password) {
								...
								query, arguments := databasetools.QueryMaker("select", []string{"id", "userId", "username", "password", "firstName", "lastName", "email", "phoneNumber", "rule", "suspended"}, "users", [][]string{{"username", username}, {"password", password}, {"rule", "admin"}}, [][]string{})
...
func ValidateUser(username string, password string) bool {
	...
	query, arguments := databasetools.QueryMaker("select", []string{"id", "userId", "username", "firstName", "lastName", "email", "phoneNumber"}, "users", [][]string{{"username", username}, {"password", password}, {"rule", "admin"}}, [][]string{})
	user := useruser.ReadUser(query, arguments)
